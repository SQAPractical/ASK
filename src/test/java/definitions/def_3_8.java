...
public class def_3_8 {
    ...
    @Then("I click on first option radio-button for question {string}")
    ...
    public void iDecreaseThePassingRateTo(String arg0) throws Throwable {
        ...
        String rate = (getDriver().findElement(By.xpath("//*[contains(text(),'Passing Rate')]/../h1")).getText());
        assertThat(rate.equalsIgnoreCase(arg0));
    }

    @And("I click on first checkbox  for question {string}")
    public void iClickOnFirstCheckboxForQuestion(String NumberOfQuestion) throws Throwable {
        ...
        if (NumberOfQuestion.equalsIgnoreCase("seven")) {
            ...
            getDriver().findElement(By.xpath("//mat-panel-title[contains(text(),'Q8')]/../../..//textarea[@placeholder='Option 1*']/../../../../..//mat-checkbox\n")).click();
        } else if (NumberOfQuestion.equalsIgnoreCase("nine")) {
            getDriver().findElement(By.xpath("//mat-panel-title[contains(text(),'Q9')]/../../..//textarea[@placeholder='Option 1*']/../../../../..//mat-checkbox\n")).click();
        } else {
            System.out.println("not implemented");
        }
    }
