...
public class userFirstName {
    ...
    public void iTypeEmail(String mail) {
        getDriver().findElement(By.xpath("//*[@placeholder='Email']")).sendKeys(mail);    }
    ...
    public void iConfirmPassword(String ConPass) {
    getDriver().findElement(By.xpath("//*[@placeholder='Confirm Password']")).sendKeys(ConPass);
    }
